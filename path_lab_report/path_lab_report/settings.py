"""
Django settings for path_lab_report project.
...
ALLOWED_HOSTS = ['path-lab-report-dev3.eu-central-1.elasticbeanstalk.com']
# ALLOWED_HOSTS = []
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # TODO deal with that later
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'path_lab_report.urls'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=10),  # TODO change this and read about it
